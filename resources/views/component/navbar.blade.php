<nav class="navbar navbar-expand-md navbar-white bg-white py-4 fixed-top" style="padding-left: 30px; padding-right: 30px;">
    <div class="container-fluid d-flex justify-content-between">
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto align-items-center">
                <li>
                    <svg class="me-2" width="24" height="24" viewBox="0 0 24 24" fill="black" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <path d="M20 6.5H4V5H20V6.5ZM20 11.25H4V12.75H20V11.25ZM20 17.5H4V19H20V17.5Z" fill="var(--_g-icon-fill-color)"></path>
                    </svg>
                </li>
                <li>
